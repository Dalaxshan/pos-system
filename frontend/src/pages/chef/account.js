...
import { AccountNotificationsSettings } from 'src/sections/chef/account/account-notifications-settings';
...
const Page = () => {
  ...
  const {
    ...
    mutate,
    isLoading,
  } = useSWRImmutable(userId ? ['chef-details', userId] : null, async () => {
