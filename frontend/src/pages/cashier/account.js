...
import { AccountNotificationsSettings } from 'src/sections/cashier/account/account-notifications-settings';
...
const Page = () => {
  ...
  const {
    ...
    mutate,
    isLoading,
  } = useSWRImmutable(userId ? ['cashier-details', userId] : null, async () => {
